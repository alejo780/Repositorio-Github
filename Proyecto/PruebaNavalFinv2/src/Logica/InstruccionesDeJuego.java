...
public class InstruccionesDeJuego {
    ...
    public static void mostrarInstruccionesInicialesDeJuego(){
        ...
        instrucciones = "  Guerra Naval es un juego que se desarrolla sobre dos tableros de tamaño 15 por 15.\n" + 
                        ...
                        "- El usuario deberá situar 3 tipos de naves en su tablero, los cuales son los siguientes:\n" + 
                        "     a) barco, ocupa una posición, son 10 en el campo juego.\n" + 
                        "     b) barcos horizontales, ocupan dos posiciones, son 5 en campo el juego.\n" + 
                        "     c) barcos verticales, ocupan dos posiciones, son 5 en el campo de juego.\n" + 
